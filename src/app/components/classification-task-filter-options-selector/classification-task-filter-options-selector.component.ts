...
export class ClassificationTaskFilterOptionsSelectorConfig {
...
@Component({
  selector: 'app-classification-task-filter-options-selector',
  templateUrl: './classification-task-filter-options-selector.component.html',
  styleUrls: ['./classification-task-filter-options-selector.component.scss'],
})
export class ClassificationTaskFilterOptionsSelectorComponent implements OnInit {
  ...
  @Input() public sortOption = ClassificationTaskListSortOption.REQUEST_TIME_DESCENDING;
  @Input() public selectorConfig = new ClassificationTaskFilterOptionsSelectorConfig();
  ...
  @Output() public sortOptionUpdated = new EventEmitter<ClassificationTaskListSortOption>();
  ...
  public classificationTaskListSortOptionList: ClassificationTaskListSortOption[] = [
    ClassificationTaskListSortOption.ID_ASCENDING,
    ClassificationTaskListSortOption.ID_DESCENDING,
    ClassificationTaskListSortOption.REQUEST_TIME_ASCENDING,
    ClassificationTaskListSortOption.REQUEST_TIME_DESCENDING
  ];
  ...
  public getClassificationTaskListSortOptionString(sortOption: ClassificationTaskListSortOption): string {
    switch (sortOption) {
      case ClassificationTaskListSortOption.ID_ASCENDING:
        return 'Classification task ID (Asc.)';
      case ClassificationTaskListSortOption.ID_DESCENDING:
        return 'Classification task ID (Desc.)';
      case ClassificationTaskListSortOption.REQUEST_TIME_ASCENDING:
        return 'Request time (Asc.)';
      case ClassificationTaskListSortOption.REQUEST_TIME_DESCENDING:
  ...
  public onSelectedClassificationTaskListSortOptionChanged(option: ClassificationTaskListSortOption): void {
