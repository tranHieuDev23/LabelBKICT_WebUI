...
export class AddableTagListComponent {
  ...
  public onDeleteImageTag(deletedImageTag: ImageTag): void {
    ...
    this.updateCurrentAndAddedImageTagList(
      ...
      this._addedImageTagList.filter((imageTag) => imageTag.id !== deletedImageTag.id)
    );
  ...
  public onAddImageTag(addedImageTag: ImageTag): void {
    ...
    this.updateCurrentAndAddedImageTagList(this._currentImageTagList, [...this._addedImageTagList, addedImageTag]);
    this.imageTagAdded.emit(addedImageTag);
  }

  private updateCurrentAndAddedImageTagList(currentImageTagList: ImageTag[], addedImageTagList: ImageTag[]): void {
    ...
    this.addedImageTagIdSet = new Set(addedImageTagList.map((imageTag) => imageTag.id));
    this.newImageTagIdSet = new Set(this._newImageTagList.map((imageTag) => imageTag.id));
  }
}
